...
2. (In background agent) Run: node ${scriptDir}/quiz-data.js
...
4. (In background agent) IMMEDIATELY save the quiz to MongoDB by piping JSON to stdin:
   echo '{"questions":[{"q":"...","choices":["A)...","B)...","C)...","D)..."],"answer":"B"},...]}' | node ${scriptDir}/quiz-save.js
...
8. Run: node ${scriptDir}/quiz-mark-done.js
